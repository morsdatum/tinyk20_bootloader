...
#if 1 /* << EST */
static TaskHandle_t msc_valid_file_timeout_task_id;
static TaskHandle_t flash_programming_task_id;
#else
...
#if 1 /* << EST */
  xEventGroupSetBits(transferEventGroup, MSC_TIMEOUT_STOP_EVENT);
#else
...
static int program_page(unsigned long adr, unsigned long sz, unsigned char *buf) {
    ...
    disable_usb_irq();
#if 1 /* << EST */
    xEventGroupSetBitsFromISR(transferEventGroup, PROGRAM_PAGE_EVENT, NULL);
#else
...
#else
static void flash_programming_task(void *param) {
...
#if 1 /* << EST */
        xEventGroupSetBits(transferEventGroup, FLASH_INIT_EVENT);
#else
        ...
        if (idx_size != -1) {
            ...
            if ((sector_received_first == 1) && (current_sector == nb_sector) && (jtag_flash_init == 1)) {
                if (msc_event_timeout == 0) {
                    msc_event_timeout = 1;
#if 1 /* << EST */
                    xEventGroupSetBitsFromISR(transferEventGroup, MSC_TIMEOUT_SPLIT_FILES_EVENT, NULL);
#else
    ...
    if (block >= SECTORS_ERROR_FILE_IDX) {
        ...
        if (jtag_flash_init == 1) {
            ...
            if ((flash_started == 0) && (theoretical_start_sector == block)) {
                flash_started = 1;
#if 1 /* << EST */
                xEventGroupSetBits(transferEventGroup, MSC_TIMEOUT_START_EVENT);
#else
...
#if 1 /* << EST */
        if (xTaskCreate(msc_valid_file_timeout_task, "MSC", MSC_TASK_STACK, NULL, MSC_TASK_PRIORITY, NULL) != pdPASS) {
          for(;;){} /* error! probably out of memory */
        }
        if (xTaskCreate(flash_programming_task, "Flash", MSC_TASK_STACK, NULL, FLASH_PROGRAMMING_TASK_PRIORITY, NULL) != pdPASS) {
          for(;;){} /* error! probably out of memory */
        }
#else
...
void USBD_Interface_Event (void) { }
void USBD_Feature_Event (void) { }
void USBD_Error_Event (void) { }
void USBD_Reset_Event (void) { }
void USBD_Suspend_Event (void) { }
void USBD_Resume_Event (void) { }
void USBD_SOF_Event (void) { }

void USBD_EndPoint1 (U32 event) {}
void USBD_EndPoint3 (U32 event) {}
void USBD_EndPoint4 (U32 event) {}
void USBD_EndPoint5 (U32 event) {}
void USBD_EndPoint6 (U32 event) {}
void USBD_EndPoint7 (U32 event) {}
void USBD_EndPoint8 (U32 event) {}
void USBD_EndPoint9 (U32 event) {}
void USBD_EndPoint10 (U32 event) {}
void USBD_EndPoint11 (U32 event) {}
void USBD_EndPoint12 (U32 event) {}
void USBD_EndPoint13 (U32 event) {}
void USBD_EndPoint14 (U32 event) {}
void USBD_EndPoint15 (U32 event) {}
#endif
